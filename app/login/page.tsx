  ...
  return (
    <div className={styles.loginForm}>
      <TitleDescription
        ...
        description="Sign in to find and book sports activities near you"
      />
        ...
        <div className={styles.content}>
          ...
          <div className={styles.heroContainer}>
            <div className={styles.heroContent}>
              <h2 className={styles.heroTitle}>Find Your Game</h2>
              <p className={styles.heroSubtitle}>
                Discover sports centers, activities, and communities near you
              </p>
            </div>
          </div>
        </div>
